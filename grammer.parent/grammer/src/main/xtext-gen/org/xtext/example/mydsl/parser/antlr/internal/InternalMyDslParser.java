...
public class InternalMyDslParser extends AbstractInternalAntlrParser {
    ...
    // InternalMyDsl.g:108:1: ruleRuleFragments returns [EObject current=null] : (otherlv_0= 'create rule' ( (lv_ruleName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_ruleBody_3_0= ruleRuleBody ) ) otherlv_4= '}' ) ;
    public final EObject ruleRuleFragments() throws RecognitionException {
        ...
        try {
            // InternalMyDsl.g:114:2: ( (otherlv_0= 'create rule' ( (lv_ruleName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_ruleBody_3_0= ruleRuleBody ) ) otherlv_4= '}' ) )
            // InternalMyDsl.g:115:2: (otherlv_0= 'create rule' ( (lv_ruleName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_ruleBody_3_0= ruleRuleBody ) ) otherlv_4= '}' )
            {
            // InternalMyDsl.g:115:2: (otherlv_0= 'create rule' ( (lv_ruleName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_ruleBody_3_0= ruleRuleBody ) ) otherlv_4= '}' )
            // InternalMyDsl.g:116:3: otherlv_0= 'create rule' ( (lv_ruleName_1_0= RULE_ID ) ) otherlv_2= '{' ( (lv_ruleBody_3_0= ruleRuleBody ) ) otherlv_4= '}'
            {
            otherlv_0=(Token)match(input,11,FOLLOW_4); 

            			newLeafNode(otherlv_0, grammarAccess.getRuleFragmentsAccess().getCreateRuleKeyword_0());

...
public class InternalMyDslParser extends AbstractInternalContentAssistParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_ID", "RULE_INT", "RULE_STRING", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'mindtree'", "'rohit'", "'abhishek'", "'credit'", "'debit'", "'<'", "'>'", "'transfer'", "'request'", "'create rule'", "'{'", "'}'", "'when'", "'then '", "'to'"
    };
    ...
    // InternalMyDsl.g:343:1: rule__RuleFragments__Group__0__Impl : ( 'create rule' ) ;
    public final void rule__RuleFragments__Group__0__Impl() throws RecognitionException {

        		int stackSize = keepStackSize();
        	
        try {
            // InternalMyDsl.g:347:1: ( ( 'create rule' ) )
            // InternalMyDsl.g:348:1: ( 'create rule' )
            {
            // InternalMyDsl.g:348:1: ( 'create rule' )
            // InternalMyDsl.g:349:2: 'create rule'
            {
